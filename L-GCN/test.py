...
def main(args):
    ...
    clusters = graph_propagation(
        edges, scores, max_sz=900, step=0.6, pool='avg')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--val_feat_path', type=str, metavar='PATH',
                        default=osp.join(working_dir, 'data/test_feat.npy'))
    parser.add_argument('--val_knn_graph_path', type=str, metavar='PATH',
                        default=osp.join(working_dir, 'data/test_knn.npy'))
    parser.add_argument('--val_label_path', type=str, metavar='PATH',
                        default=osp.join(working_dir, 'data/test_label.npy'))

    # Test args
    parser.add_argument('--checkpoint', type=str,
                        metavar='PATH', default='./logs/epoch_4.ckpt')
