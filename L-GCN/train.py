...
if __name__ == '__main__':
    ...
    parser.add_argument('--print_freq', default=70, type=int)
    ...
    parser.add_argument('--feat_path', type=str, metavar='PATH',
                        default=osp.join(working_dir, 'data/myFeat.npy'))
    parser.add_argument('--knn_graph_path', type=str, metavar='PATH',
                        default=osp.join(working_dir, 'data/myKnn.npy'))
    parser.add_argument('--label_path', type=str, metavar='PATH',
                        default=osp.join(working_dir, 'data/myLabel.npy'))
